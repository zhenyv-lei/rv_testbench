...
static void topTwoIdx(uint64_t* inArray, uint64_t inArraySize, uint8_t* outIdxArray, uint64_t* outValArray){
    outValArray[0] = 0;
    outValArray[1] = 0;
...
static void read_byte(char *addr_to_read, uint8_t result[2], uint64_t score[2], uint64_t threshold)
{
    uint64_t hits[256];
    int junk = 0;
